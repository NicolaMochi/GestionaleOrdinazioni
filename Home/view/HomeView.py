...
from Ingredienti_list.controller.IngredienteListController import IngredienteListController
...
from Ordini_list.view.NuovoOrdineView import NuovoOrdineView
...
class HomeView(QMainWindow):
    def __init__(self):
        ...
        self.personale_view = PersonaleListView(self.home, self.controller_lista_personale, self.add_personale_view, self.uifunctions)
        ...
        self.lista_ingredienti = IngredienteListController()
        ...
        self.nuova_portata_view = NewPortataView(self.menu_vista, self.menu, self.lista_ingredienti, self.lista_categorie)

        self.lista_ordini = OrdiniListController()
        self.vista_nuovo_ordine = NuovoOrdineView(self.lista_categorie, self.home, self.lista_ordini, self.lista_tavoli_controller, self.menu)
